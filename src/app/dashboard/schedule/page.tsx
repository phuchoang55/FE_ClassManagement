    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
        ...
        <select
          ...
          className="w-full max-w-sm rounded-xl border border-slate-200 px-4 py-2.5 text-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-100"
        >
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
            ...
            {loading ? (
              ...
              <p className="text-sm text-slate-400 py-8 text-center">
                Chưa có lịch học. Hãy thêm lịch mới.
              </p>
            ) : (
                  ...
                  >
                    <div>
                      ...
                      <div className="flex items-center gap-1 text-sm text-slate-500 mt-0.5">
                        ...
                        {s.room && (
                          <span className="ml-2 rounded-md bg-indigo-100 px-1.5 py-0.5 text-xs text-indigo-600">
                            {s.room}
                          </span>
                        )}
                      </div>
          ...
          <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
            ...
            <div className="space-y-4">
              ...
              <button
                id="btn-add-schedule"
                onClick={handleAdd}
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 py-2.5 text-sm font-semibold text-white shadow-lg shadow-indigo-200 hover:from-indigo-700 hover:to-purple-700 transition-all"
              >
                <Plus size={18} />
                Thêm lịch học
              </button>
